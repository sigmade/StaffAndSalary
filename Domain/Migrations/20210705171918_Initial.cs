        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkTimes_Positions_PositionId",
                        column: x => x.PositionId,
                        principalTable: "Positions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkTimes_Workers_PersonId1",
                        column: x => x.PersonId1,
                        principalTable: "Workers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkTimes_WorkLocations_WorkLocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkTimes_PersonId1",
                table: "WorkTimes",
                column: "PersonId1");

            migrationBuilder.CreateIndex(
                name: "IX_WorkTimes_PositionId",
                table: "WorkTimes",
                column: "PositionId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkTimes_WorkLocationId",
                table: "WorkTimes",
